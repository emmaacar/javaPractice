...
public class ScrumTeam {
    ...
    public ProducktOwner PO;
    public BusnessAnalyst BA;
    public ScrumMuster SM;
    ...
    public ScrumTeam(ProducktOwner PO, BusnessAnalyst BA, ScrumMuster SM) {
        this.PO = PO;
        this.BA = BA;
        this.SM = SM;
