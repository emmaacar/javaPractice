...
public class ArraysUtility {
    ...
    // print each double of and double array in separate lines
    ...
    //print each char of and char array in separate lines
    ...
    //print each string of and string array in separate lines
    ...
    // check if the given integer is contained in the given array,return boolean.contains(int[], int)
    public static boolean contains(int[] array, int element) {

        boolean result = false;

        for (int each : array) {
            if (each == element) { //f any array's element is matching with the given element, it means the given elements is contained in the array
                result = true;
            }
